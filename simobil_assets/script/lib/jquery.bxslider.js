     ...
     * ===================================================================================
      ...
      if(slider.settings.breaks) {
		 ...
		 */
			...
			slider.parfix = slider.settings.parfix;
			setup();
		}
		...
		var updateAfterSlideTransition = function(){
			...
			if(slider.settings.infiniteLoop){
				...
				// carousel, last slide
				if(slider.carousel && index == getPagerQty() - 1){
					index *= getMoveBy();
				}
				var position = slider.children.eq(index).position(),
					reset = slider.settings.mode == 'horizontal'?-position.left:-position.top;
				setPositionProperty(reset, 'reset', 0);
			}
